...
categories: pubs
excerpt:
tags: [gravity, general relativity, black holes, chaos, dynamics]
pub:
  authors: "Roman Berens, Peter Galison, Trevor Gravely, Alexandru Lupsasca, Leo C. Stein"
  doi:
  arXiv: "2603.08790"
  jref:
date: 2026-03-10
...
![]({{ site.url }}/images/posts/chaos-at-the-light-ring/basins.png)
{: .align-right style="width: 350px; margin: 2em 0 0 1em;"}
> The photon ring of a Kerr black hole decomposes into a self-similar hierarchy
of subrings. Here, we show that this self-similar structure persists in phase
...
one illustrating the emergence of chaos near the photon shell, which results in
a fractal phase-space structure, and another exhibiting how this chaotic,
fractal, self-similar structure is encoded in the first-return map.
